...
const divisionFAQs: Record<Division, FAQ[]> = {
  ...
  events: [
    ...
    { question: 'What stage design and fabrication services do you offer?', answer: 'We design and build custom stages of all scales — from intimate corporate setups to large concert and festival stages. Our in-house team handles structural engineering, scenic elements, LED integration, and thematic backdrops tailored to your event vision.' },
