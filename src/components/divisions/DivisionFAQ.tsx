...
const divisionFAQs: Record<Division, FAQ[]> = {
  ...
  events: [
    ...
    { question: 'What stage design and fabrication services do you offer?', answer: 'We design and build custom stages of all scales — from corporate setups and elegant wedding stages to large concert and festival productions. Our in-house team handles structural engineering, scenic elements, LED integration, floral and thematic décor, and stunning backdrops tailored to your event vision.' },
