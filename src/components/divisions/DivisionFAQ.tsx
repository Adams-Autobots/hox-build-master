...
const divisionFAQs: Record<Division, FAQ[]> = {
  ...
  events: [
    ...
    { question: 'What stage design and fabrication services do you offer?', answer: 'We design and build custom stages of all scales — from intimate corporate setups and elegant wedding stages to large concert and festival productions. Our in-house team handles structural engineering, scenic elements, LED integration, floral and thematic décor, and stunning backdrops tailored to your event vision.' },
    { question: 'Do you handle thematic production and set design?', answer: 'Absolutely. We create immersive environments through custom set design, scenic fabrication, and thematic décor. Whether it\'s a product launch, gala, or brand activation, we bring creative concepts to life with precision craftsmanship.' },
  ],
  retail: [
