...
const heroWords = [{
  word: 'Exhibitions',
  color: 'hsl(var(--hox-red))'
}, {
  word: 'Events',
  color: 'hsl(var(--hox-blue))'
}, {
  word: 'Retail',
  color: 'hsl(var(--hox-orange))'
}, {
  word: 'Interiors',
  color: 'hsl(var(--hox-green))'
}];
export function HeroSection() {
  ...
  return <section className="relative min-h-screen flex items-center overflow-visible">
      {/* Fixed Background Video - stays constant while content scrolls */}
      <motion.div className="fixed inset-0 w-full h-screen pointer-events-none" style={{
