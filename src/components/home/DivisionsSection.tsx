  ...
  return (
    <section className="py-24 lg:py-32 bg-background relative">
      <div className="container mx-auto px-6 lg:px-12">
        {/* Stats strip — lean, no boxes, just facts */}
        <motion.div
          className="flex flex-wrap gap-x-12 gap-y-4 mb-16 lg:mb-20"
        ...
        >
          <div className="flex items-baseline gap-2">
            <span className="text-3xl md:text-4xl font-bold text-foreground">17+</span>
            <span className="text-sm text-muted-foreground">years</span>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl md:text-4xl font-bold text-foreground">3,000+</span>
            <span className="text-sm text-muted-foreground">projects</span>
          </div>
          <div className="flex items-baseline gap-2">
            <span className="text-3xl md:text-4xl font-bold text-foreground">50+</span>
